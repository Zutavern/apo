...
import { LayoutGrid, Columns, Rows, ChevronLeft, ChevronRight } from 'lucide-react'
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <a 
            ...
            className="inline-flex items-center justify-center rounded-md h-10 px-4 py-2 bg-gray-900/50 border border-white/10 hover:bg-gray-900/70 transition-colors"
