    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto relative overflow-hidden">
        <div className="sticky top-0 z-10 bg-background pt-8 pb-6">
          <h1 className="text-3xl font-bold px-4">Apotheken Notdienste - {heute}</h1>
          {message && (
        ...
        >
          {duplicatedApotheken.map((apotheke, index) => (
            <Card key={`${apotheke.id}-${index}`} className="transition-opacity duration-1000">
                ...
                <div className="grid sm:grid-cols-[1fr,auto] gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="pl-9 space-y-2">
                      ...
                      <p className="flex items-center space-x-2">
                        ...
                        <span>0{apotheke.plz} {apotheke.ort}</span>
                      </p>
                      <p className="flex items-center space-x-2">
                        <svg className="w-4 h-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span className="font-medium">{apotheke.telefon || 'Keine Telefonnummer verfügbar'}</span>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="min-w-[280px] flex flex-col justify-between">
                    ...
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <span className="font-bold text-lg">{apotheke.entfernung || 'Entfernung nicht verfügbar'}</span>
                    </div>
                  </div>
                </div>
              </CardContent>
